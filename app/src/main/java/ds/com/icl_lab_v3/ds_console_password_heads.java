...
public class ds_console_password_heads extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.password_screen_heads);
    ...
    public void enter_password (View v){
        ...
        if (enter_password.equals(pw)){
            Intent intent = new Intent(this, system_config.class);
